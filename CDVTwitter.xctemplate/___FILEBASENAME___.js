 ...
 *      });
 */
___FILEBASENAME___.prototype.isTwitterAvailable = function(response){
    cordova.exec(response, null, "___FILEBASENAME___", "isTwitterAvailable", []);
};
/**
 ...
 *      });
 */
___FILEBASENAME___.prototype.isTwitterSetup = function(response){
    cordova.exec(response, null, "___FILEBASENAME___", "isTwitterSetup", []);
};
/**
 ...
 * );
 */
___FILEBASENAME___.prototype.composeTweet = function(success, failure, tweetText, options){
    options = options || {};
    options.text = tweetText;
    cordova.exec(success, failure, "___FILEBASENAME___", "composeTweet", [options]);
};
/**
 ...
 */
___FILEBASENAME___.prototype.getPublicTimeline = function(success, failure){
    cordova.exec(success, failure, "___FILEBASENAME___", "getPublicTimeline", []);
};
/**
 ...
 * [Twitter Timeline Doc]: https://dev.twitter.com/docs/api/1/get/statuses/public_timeline
 */
___FILEBASENAME___.prototype.getMentions = function(success, failure){
    cordova.exec(success, failure, "___FILEBASENAME___", "getMentions", []);
};
/**
 ...
 */
___FILEBASENAME___.prototype.getTwitterUsername = function(success, failure) {
    cordova.exec(success, failure, "___FILEBASENAME___", "getTwitterUsername", []);
};
/**
 * Gets Tweets from Twitter Mentions API
 ...
 */
___FILEBASENAME___.prototype.getTWRequest = function(url, params, success, failure, options){
    options = options || {};
    options.url = url;
    options.params = params;
    cordova.exec(success, failure, "___FILEBASENAME___", "getTWRequest", [options]);
};
// Plug in to Cordova
